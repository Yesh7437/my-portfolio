  ...
  return (
    <footer className="footer">
      <div className="footer-links">
        <a href="https://github.com/Yesh7437" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
        ...
        <a href="https://www.linkedin.com/in/yeshwanth-barla-612337223/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
          <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
      ...
      <p className="footer-copy">&copy; {new Date().getFullYear()} Yeshwanth Sai Barla. All rights reserved.</p>
    </footer>
  )
}
